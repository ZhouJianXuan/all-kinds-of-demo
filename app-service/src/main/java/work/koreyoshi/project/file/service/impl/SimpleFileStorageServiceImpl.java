package work.koreyoshi.project.file.service.impl;
...
import work.koreyoshi.project.file.service.FileStorageService;
...
public class SimpleFileStorageServiceImpl extends BaseService<FileStorage> implements FileStorageService{
    ...
    @Value("${fileStorage.secondary.path:\\}")
    ...
    public String saveFile(File file) {
        ...
        try {
            ...
            int len;
            // 输出的文件流保存到本地文件
            String path = basePath + secondaryPath;
